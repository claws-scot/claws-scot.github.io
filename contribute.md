...
6. Press the [_New pull request_](https://github.com/vincentcasseau/CLAWS/compare) button in the _Pull Requests_ tab   
    <div style="line-height:50%;">
        <br>
    </div>
7. Compare the _main_ on vincentcasseau/CLAWS with your _main_ on USERNAME/CLAWS and press _Create pull request_ once you are done
    <div style="line-height:50%;">
        <br>
    </div>
