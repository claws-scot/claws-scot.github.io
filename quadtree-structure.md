...
The <i>get_lonlat_bins</i> function presented in the <a href="https://claws-scot.github.io/ensemble-averaging">Ensemble averaging</a> Section is thus revised below to accommodate a quadtree histogram structure whereby a 2 x 2 sub-histogram is created for root and parent histogram bins selected for refinement. A sub-histogram has the following properties:</p>
