...
<p>A particle represents a mass of a chemical substance in a water voxel and releasing 1,000,000 particles corresponds to 1,000,000 realizations of how this substance may be transported within the bounds of a numerical domain.
...
<p>To resort to these two strategies, the number of longitude and latitude bins (and the latitude and longitude ranges) as generated by the the multi-dimensional histogram need to be the same. This is not possible with the code available on Github as the plot bounding box corners are based on the latitude and longitude extremas of the particle cloud to reduce the memory usage. Hence, the keyword <i>'corners'</i> is passed to <i>**kwargs</i> in the <i>get_lonlat_bins</i> function in basemodel.py to alleviate this issue:</p>
...
<sup id="fn1">1. <a href="https://opendrift.github.io/performance.html" target="_blank"> </a><a href="#ref1" title="Jump back to footnote 1 in the text.">&#8617;</a></sup>
